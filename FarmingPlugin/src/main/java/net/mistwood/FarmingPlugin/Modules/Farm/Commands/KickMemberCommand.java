...
public class KickMemberCommand implements SubCommand
{
    ...
    public KickMemberCommand (Main Instance)
    {
    ...
    {
        if (Args.length > 0 && (Sender instanceof Player && Instance.PermissionManager.HasCommandPermission (Sender, "kick")))
        {
            Player Target = (Player) Sender;

            CommandHelper.HandleKickMember (Instance, Target, Args[0]);
